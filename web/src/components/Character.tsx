          ...
          <div style={{ display: "flex", gap: "15px", alignItems: "center" }}>
            ...
            >
              ...
              >
                ...
                >
                  {["#FFA012", "#FF6600", "#201108", "#1e1e20", "#BFBFBF"].map(
                    (color) => (
                      <div
                        key={color}
                        onClick={() =>
                          setFormData((prev) => ({ ...prev, hairColor: color }))
                        }
                        style={{
                          width: "20px",
                          height: "20px",
                    ...
                    {[
                      ...
                      <div
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          border:
                            (formData.beardColor || "").toUpperCase() ===
                            color.toUpperCase()
                              ? "2px solid #007bff"
                              : "2px solid transparent",
                          boxShadow:
